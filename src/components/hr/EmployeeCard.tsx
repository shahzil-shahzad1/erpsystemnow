...
// Employee Card Component (reused from EmployeeManagementPage for consistent styling)
const EmployeeCard: React.FC<EmployeeCardProps> = ({ title, value, icon: Icon, iconBgColor, iconColor, situation, status, trend }) => {
  return (

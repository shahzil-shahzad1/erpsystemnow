...
export function AnimatedBeamSection() {
    ...
    return (
        <section className="relative w-full py-16 sm:py-20 md:py-24 lg:py-32 px-4 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-black overflow-hidden">
            {/* Background Elements */}
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <motion.div
                    ...
                    className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-br from-orange-200/20 to-orange-300/20 dark:from-orange-400/10 dark:to-orange-500/10 rounded-3xl blur-xl"
                />
                <motion.div
                    animate={{
                        y: [0, 15, 0],
                    ...
                    className="absolute bottom-32 right-16 w-24 h-24 bg-gradient-to-br from-blue-200/20 to-blue-300/20 dark:from-blue-400/10 dark:to-blue-500/10 rounded-2xl blur-xl"
                />
                <motion.div
                    animate={{
                        y: [0, -10, 0],
                    ...
                    className="absolute top-1/2 right-8 w-20 h-20 bg-gradient-to-br from-emerald-200/20 to-emerald-300/20 dark:from-emerald-400/10 dark:to-emerald-500/10 rounded-full blur-xl"
                />
            </div>
            ...
            <div className="relative max-w-7xl mx-auto">
                ...
                >
                    ...
                    <div className="relative max-w-3xl mx-auto">
                        <p className="text-sm sm:text-base md:text-lg text-gray-600 dark:text-gray-300 px-4 sm:px-6 leading-relaxed font-light mb-6">
                            Connect and streamline your workflow with our powerful integration network.
                            <span className="block mt-2 font-medium text-orange-600 dark:text-orange-400">
                                Experience seamless data flow between your favorite tools and platforms.
                            </span>
                        </p>
                ...
                {/* Enhanced Animated Beam Container */}
                <motion.div
                ...
                >
                    ...
                    <div
                        ...
                        ref={containerRef}
                    >
                        <div className="flex size-full max-h-[200px] sm:max-h-[250px] md:max-h-[300px] max-w-xs sm:max-w-sm md:max-w-lg flex-col items-stretch justify-between gap-4 sm:gap-6 md:gap-10">
    ...
    googleDocs: () => (
        ...
        >
            <defs>
                ...
                />
                <path
                    d="M29.375,0 L4.40625,0 C1.9828125,0 0,1.99431818 0,4.43181818 L0,60.5681818 C0,63.0056818 1.9828125,65 4.40625,65 L42.59375,65 C45.0171875,65 47,63.0056818 47,60.5681818 L47,60.1988636 C47,62.6363636 45.0171875,64.6306818 42.59375,64.6306818 Z"
                    id="path-14"
                />
                <radialGradient
                    cx="3.16804688%"
